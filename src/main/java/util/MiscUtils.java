...
public class MiscUtils {
    ...
    public static int FlatPriceSearchForIndex(ArrayList<Flat> flats, double value) {
        ...
        //if flats are sorted in ascending order according to forSalePrice, then the function returns the index where a flat with the given value could be inserted
